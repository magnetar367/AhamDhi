...
splash_root = Tk()
splash_root.title('digital therapist')
splash_root.geometry("586x563")

# Set Label
photo= PhotoImage(file='Screenshot (114).png')#Update to be made here!
...
class ChatApplication:
    ...
    def _setup_main_window(self):
        self.window.title("~AhamDhi")
        self.window.resizable(width=False, height=False)
        self.window.configure(width=470, height=550, bg="#000337")

        #headlabel
        head_label = Label(self.window, bg="gray16", fg="lawn green", text="Chat", font="ComicSans 11", pady=10)
